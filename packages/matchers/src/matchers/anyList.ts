...
export class AnyListMatcher<T> extends Matcher<Array<T>> {
  private readonly sliceMatchers: Array<SliceMatcher> = []

  constructor(private readonly matchers: Array<Matcher<T> | SliceMatcher>) {
    super()
...
export function anyList<T>(
  ...elements: Array<Matcher<T> | SliceMatcher>
): Matcher<Array<T>> {
