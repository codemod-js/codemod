...
export class ArrayPatternMatcher extends Matcher<t.ArrayPattern> {
  constructor(
    private readonly elements?:
      | Matcher<Array<null | t.PatternLike | t.LVal>>
      | Array<Matcher<null> | Matcher<t.PatternLike> | Matcher<t.LVal>>
  ) {
    super()
  }
...
export class ClassAccessorPropertyMatcher extends Matcher<t.ClassAccessorProperty> {
  ...
  matchValue(
    ...
    if (!isNode(node) || !t.isClassAccessorProperty(node)) {
      return false
    }
...
export class DecimalLiteralMatcher extends Matcher<t.DecimalLiteral> {
  ...
  matchValue(
    ...
    if (!isNode(node) || !t.isDecimalLiteral(node)) {
      return false
    }
...
export class ImportAttributeMatcher extends Matcher<t.ImportAttribute> {
  ...
  matchValue(
    ...
    if (!isNode(node) || !t.isImportAttribute(node)) {
      return false
    }
...
export class IndexedAccessTypeMatcher extends Matcher<t.IndexedAccessType> {
  ...
  matchValue(
    ...
    if (!isNode(node) || !t.isIndexedAccessType(node)) {
      return false
    }
...
export class ModuleExpressionMatcher extends Matcher<t.ModuleExpression> {
  ...
  matchValue(
    ...
    if (!isNode(node) || !t.isModuleExpression(node)) {
      return false
    }
...
export class OptionalIndexedAccessTypeMatcher extends Matcher<t.OptionalIndexedAccessType> {
  ...
  matchValue(
    ...
    if (!isNode(node) || !t.isOptionalIndexedAccessType(node)) {
      return false
    }
...
export class StaticBlockMatcher extends Matcher<t.StaticBlock> {
  ...
  matchValue(
    ...
    if (!isNode(node) || !t.isStaticBlock(node)) {
      return false
    }
...
export class TSInstantiationExpressionMatcher extends Matcher<t.TSInstantiationExpression> {
  ...
  matchValue(
    ...
    if (!isNode(node) || !t.isTSInstantiationExpression(node)) {
      return false
    }
...
export class TSIntrinsicKeywordMatcher extends Matcher<t.TSIntrinsicKeyword> {
  ...
  matchValue(
    ...
    if (!isNode(node) || !t.isTSIntrinsicKeyword(node)) {
      return false
    }
...
export class TSNamedTupleMemberMatcher extends Matcher<t.TSNamedTupleMember> {
  ...
  matchValue(
    ...
    if (!isNode(node) || !t.isTSNamedTupleMember(node)) {
      return false
    }
...
export class TSSatisfiesExpressionMatcher extends Matcher<t.TSSatisfiesExpression> {
  ...
  matchValue(
    ...
    if (!isNode(node) || !t.isTSSatisfiesExpression(node)) {
      return false
    }
...
export class TopicReferenceMatcher extends Matcher<t.TopicReference> {
  ...
  matchValue(
    ...
    if (!isNode(node) || !t.isTopicReference(node)) {
      return false
    }
